...
pub mod ERC20FaucetToken {
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolEvent for FaucetAmountSet {
            ...
            const SIGNATURE_HASH: alloy_sol_types::private::B256 =
                alloy_sol_types::private::B256::new([
                    107u8, 72u8, 94u8, 39u8, 64u8, 87u8, 58u8, 87u8, 175u8, 31u8, 233u8, 172u8,
                    211u8, 249u8, 163u8, 62u8, 164u8, 178u8, 107u8, 140u8, 216u8, 140u8, 109u8,
                    45u8, 170u8, 150u8, 112u8, 54u8, 209u8, 177u8, 195u8, 141u8,
                ]);
            const ANONYMOUS: bool = false;
            #[allow(unused_variables)]
            #[inline]
    ...
    const _: () = {
        ...
        }
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<FAUCET_INTERVALReturn> for UnderlyingRustTuple<'_> {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>> for FAUCET_INTERVALReturn {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self { _0: tuple.0 }
                }
            }
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for checkpointsCall {
            ...
            #[inline]
            fn tokenize_returns(ret: &Self::Return) -> Self::ReturnToken<'_> {
                (<Checkpoints::Checkpoint208 as alloy_sol_types::SolType>::tokenize(ret),)
            }
            #[inline]
            fn abi_decode_returns(data: &[u8]) -> alloy_sol_types::Result<Self::Return> {
                <Self::ReturnTuple<'_> as alloy_sol_types::SolType>::abi_decode_sequence(data).map(
    ...
    const _: () = {
        ...
        }
        {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<setFaucetAmountReturn> for UnderlyingRustTuple<'_> {
            ...
            #[automatically_derived]
            #[doc(hidden)]
            impl ::core::convert::From<UnderlyingRustTuple<'_>> for setFaucetAmountReturn {
                fn from(tuple: UnderlyingRustTuple<'_>) -> Self {
                    Self {}
                }
            }
    ...
    impl alloy_sol_types::SolInterface for ERC20FaucetTokenCalls {
        ...
        fn selector(&self) -> [u8; 4] {
            match self {
                ...
                Self::faucetAmount(_) => <faucetAmountCall as alloy_sol_types::SolCall>::SELECTOR,
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls>] = &[
                {
                    fn name(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                ...
                {
                    fn approve(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                ...
                {
                    fn mint(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                ...
                {
                    fn totalSupply(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                ...
                {
                    fn transferFrom(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                ...
                {
                    fn decimals(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                ...
                {
                    fn getPastVotes(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                ...
                {
                    fn CLOCK_MODE(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                        <CLOCK_MODECall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20FaucetTokenCalls::CLOCK_MODE)
                    }
                    CLOCK_MODE
                },
                {
                    fn delegates(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                ...
                {
                    fn delegate(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                ...
                },
                {
                    fn FAUCET_INTERVAL(
                        ...
                        <FAUCET_INTERVALCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                ...
                },
                {
                    fn numCheckpoints(
                        ...
                        <numCheckpointsCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20FaucetTokenCalls::numCheckpoints)
                    }
                    numCheckpoints
                },
                {
                    fn balanceOf(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                ...
                {
                    fn nonces(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                ...
                },
                {
                    fn setFaucetAmount(
                        ...
                        <setFaucetAmountCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20FaucetTokenCalls::setFaucetAmount)
                    }
                    setFaucetAmount
                },
                {
                    fn eip712Domain(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                ...
                {
                    fn owner(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                ...
                {
                    fn clock(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                ...
                {
                    fn symbol(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                ...
                {
                    fn getVotes(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                ...
                {
                    fn faucetAmount(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                        <faucetAmountCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
                            .map(ERC20FaucetTokenCalls::faucetAmount)
                    }
                    faucetAmount
                },
                {
                    fn burn(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                ...
                {
                    fn transfer(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                ...
                {
                    fn lastMint(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                ...
                {
                    fn permit(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                ...
                {
                    fn allowance(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                ...
                {
                    fn checkpoints(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                        <checkpointsCall as alloy_sol_types::SolCall>::abi_decode_raw(data)
        ...
        fn abi_decode_raw_validate(
            ...
            >] = &[
                ...
                {
                    fn CLOCK_MODE(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                        <CLOCK_MODECall as alloy_sol_types::SolCall>::abi_decode_raw_validate(data)
                            .map(ERC20FaucetTokenCalls::CLOCK_MODE)
                    }
                    CLOCK_MODE
                },
                ...
                {
                    fn clock(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                        <clockCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(data)
                            .map(ERC20FaucetTokenCalls::clock)
                    }
                    clock
                },
                ...
                {
                    fn lastMint(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                        <lastMintCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(data)
                            .map(ERC20FaucetTokenCalls::lastMint)
                    }
                    lastMint
                },
                ...
                {
                    fn checkpoints(data: &[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenCalls> {
                        <checkpointsCall as alloy_sol_types::SolCall>::abi_decode_raw_validate(data)
                            .map(ERC20FaucetTokenCalls::checkpoints)
                    }
                    checkpoints
                },
        ...
        fn abi_encoded_size(&self) -> usize {
            match self {
                ...
                Self::FAUCET_INTERVAL(inner) => {
                    <FAUCET_INTERVALCall as alloy_sol_types::SolCall>::abi_encoded_size(inner)
                }
                ...
                Self::faucetAmount(inner) => {
                    <faucetAmountCall as alloy_sol_types::SolCall>::abi_encoded_size(inner)
                }
                ...
                Self::setFaucetAmount(inner) => {
                    <setFaucetAmountCall as alloy_sol_types::SolCall>::abi_encoded_size(inner)
                }
                Self::symbol(inner) => {
        ...
        fn abi_encode_raw(&self, out: &mut alloy_sol_types::private::Vec<u8>) {
            match self {
                ...
                Self::FAUCET_INTERVAL(inner) => {
                    <FAUCET_INTERVALCall as alloy_sol_types::SolCall>::abi_encode_raw(inner, out)
                }
                Self::allowance(inner) => {
                ...
                Self::faucetAmount(inner) => {
                    <faucetAmountCall as alloy_sol_types::SolCall>::abi_encode_raw(inner, out)
                }
                Self::getPastTotalSupply(inner) => {
                ...
                Self::lastMint(inner) => {
                    <lastMintCall as alloy_sol_types::SolCall>::abi_encode_raw(inner, out)
                }
                Self::mint(inner) => {
                ...
                Self::setFaucetAmount(inner) => {
                    <setFaucetAmountCall as alloy_sol_types::SolCall>::abi_encode_raw(inner, out)
                }
                Self::symbol(inner) => {
    ...
    impl alloy_sol_types::SolInterface for ERC20FaucetTokenErrors {
        ...
        #[allow(non_snake_case)]
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<ERC20FaucetTokenErrors>] =
                &[
                    {
                    ...
                    },
                    {
                        ...
                        {
                            <InvalidAccountNonce as alloy_sol_types::SolError>::abi_decode_raw(data)
                    ...
                    },
                    {
                        ...
                        {
                            <ERC5805FutureLookup as alloy_sol_types::SolError>::abi_decode_raw(data)
        ...
        fn abi_encoded_size(&self) -> usize {
            match self {
                ...
                Self::ERC20ExceededSafeSupply(inner) => {
                    <ERC20ExceededSafeSupply as alloy_sol_types::SolError>::abi_encoded_size(inner)
                }
                ...
                Self::ERC2612ExpiredSignature(inner) => {
                    <ERC2612ExpiredSignature as alloy_sol_types::SolError>::abi_encoded_size(inner)
                }
                Self::ERC2612InvalidSigner(inner) => {
                    <ERC2612InvalidSigner as alloy_sol_types::SolError>::abi_encoded_size(inner)
                }
        ...
        fn abi_encode_raw(&self, out: &mut alloy_sol_types::private::Vec<u8>) {
            match self {
                ...
                Self::ERC2612InvalidSigner(inner) => {
                    <ERC2612InvalidSigner as alloy_sol_types::SolError>::abi_encode_raw(inner, out)
                }
                Self::ERC5805FutureLookup(inner) => {
    ...
    impl ERC20FaucetTokenEvents {
        ...
        pub const SELECTORS: &'static [[u8; 32usize]] = &[
            ...
            [
                107u8, 72u8, 94u8, 39u8, 64u8, 87u8, 58u8, 87u8, 175u8, 31u8, 233u8, 172u8, 211u8,
                249u8, 163u8, 62u8, 164u8, 178u8, 107u8, 140u8, 216u8, 140u8, 109u8, 45u8, 170u8,
                150u8, 112u8, 54u8, 209u8, 177u8, 195u8, 141u8,
            ],
            [
        ...
        fn decode_raw_log(
            ...
            match topics.first().copied() {
                ...
                Some(<DelegateChanged as alloy_sol_types::SolEvent>::SIGNATURE_HASH) => {
                    <DelegateChanged as alloy_sol_types::SolEvent>::decode_raw_log(topics, data)
                ...
                Some(<FaucetAmountSet as alloy_sol_types::SolEvent>::SIGNATURE_HASH) => {
                    <FaucetAmountSet as alloy_sol_types::SolEvent>::decode_raw_log(topics, data)
    ...
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<ERC20FaucetTokenInstance<P, N>>>
    {
        ERC20FaucetTokenInstance::<P, N>::deploy(
            provider,
            name,
            symbol,
            decimals_,
    ...
    >(
        ...
        ERC20FaucetTokenInstance::<P, N>::deploy_builder(
            provider,
            name,
            symbol,
            decimals_,
    ...
    impl<P, N> ::core::fmt::Debug for ERC20FaucetTokenInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ERC20FaucetTokenInstance")
                .field(&self.address)
                .finish()
        }
    }
        ...
        ERC20FaucetTokenInstance<P, N>
    {
        ...
        pub async fn deploy(
            ...
            let call_builder =
                Self::deploy_builder(provider, name, symbol, decimals_, faucetAmount_, _owner);
        ...
        ERC20FaucetTokenInstance<P, N>
    {
        ...
        pub fn CLOCK_MODE(&self) -> alloy_contract::SolCallBuilder<&P, CLOCK_MODECall, N> {
        ...
        pub fn faucetAmount(&self) -> alloy_contract::SolCallBuilder<&P, faucetAmountCall, N> {
        ...
        pub fn setFaucetAmount(
            ...
            self.call_builder(&setFaucetAmountCall { faucetAmount_ })
        }
        ...
        ERC20FaucetTokenInstance<P, N>
    {
        ...
        pub fn DelegateChanged_filter(&self) -> alloy_contract::Event<&P, DelegateChanged, N> {
        ...
        pub fn FaucetAmountSet_filter(&self) -> alloy_contract::Event<&P, FaucetAmountSet, N> {
