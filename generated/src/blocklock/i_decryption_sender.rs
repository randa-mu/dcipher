...
pub mod IDecryptionSender {
    ...
    impl alloy_sol_types::SolInterface for IDecryptionSenderCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<IDecryptionSenderCalls>] =
                &[
                    {
                    ...
                    {
                        fn version(data: &[u8]) -> alloy_sol_types::Result<IDecryptionSenderCalls> {
        ...
        fn abi_decode_raw_validate(
            ...
            >] = &[
                ...
                {
                    fn hasErrored(data: &[u8]) -> alloy_sol_types::Result<IDecryptionSenderCalls> {
                ...
                {
                    fn getRequest(data: &[u8]) -> alloy_sol_types::Result<IDecryptionSenderCalls> {
                ...
                {
                    fn isInFlight(data: &[u8]) -> alloy_sol_types::Result<IDecryptionSenderCalls> {
    ...
    >(
        ...
        IDecryptionSenderInstance::<P, N>::new(address, provider)
    }
    ...
    pub fn deploy<P: alloy_contract::private::Provider<N>, N: alloy_contract::private::Network>(
        provider: P,
    ) -> impl ::core::future::Future<Output = alloy_contract::Result<IDecryptionSenderInstance<P, N>>>
    {
        IDecryptionSenderInstance::<P, N>::deploy(provider)
    }
    ...
    >(
        ...
        IDecryptionSenderInstance::<P, N>::deploy_builder(provider)
    }
    ...
    impl<P, N> ::core::fmt::Debug for IDecryptionSenderInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IDecryptionSenderInstance")
                .field(&self.address)
                .finish()
        }
    }
