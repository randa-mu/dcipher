...
//! to encode Bn254 (aka alt_bn128) points. We follow the encoding used by gnark as described in
...
//! to_be_bytes(x) = to_be_bytes(x_m) || to_be_bytes(x_{m - 1}) || ... || to_be_bytes(x_0)
