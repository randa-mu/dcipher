...
use super::{CustomPairingHashToCurve, PairingHashToCurve};
use ark_ec::short_weierstrass::{Projective, SWCurveConfig};
use ark_ff::MontFp;
use digest::{core_api::BlockSizeUser, DynDigest};

impl PairingHashToCurve for ark_bn254::Bn254 {
    const G1_CIPHERSUITE: &'static str = "BN254G1_XMD:SHA-256_SVDW_RO_";
    const G2_CIPHERSUITE: &'static str = "BN254G2_XMD:SHA-256_SVDW_RO_";
    type DefaultInnerHash = sha2::Sha256;
}
...
impl CustomPairingHashToCurve for ark_bn254::Bn254 {
    fn hash_to_g1_custom<H: DynDigest + BlockSizeUser + Default + Clone>(
        ...
        let q0 = svdw_map_to_curve::<ark_bn254::g1::Config>(m[0], C, Z);
        let q1 = svdw_map_to_curve::<ark_bn254::g1::Config>(m[1], C, Z);
    ...
    fn hash_to_g2_custom<H: DynDigest + BlockSizeUser + Default + Clone>(
        ...
        let q0 = svdw_map_to_curve::<ark_bn254::g2::Config>(m[0], C, Z);
        let q1 = svdw_map_to_curve::<ark_bn254::g2::Config>(m[1], C, Z);
        let r = q0 + q1;
...
mod tests {
    ...
    fn drand_compatibility_bn254_g1_hash_to_point() {
        ...
        let msg = hex::decode("e0a05cbb37fd6c159732a8c57b981773f7480695328b674d8a9cc083377f1811")
            .unwrap();
        let p = ark_bn254::Bn254::hash_to_g1_custom::<sha3::Keccak256>(&msg, DST);
        assert_eq!(
            p,
