...
pub mod ISignatureSchemeAddressProvider {
    use super::*;
...
```*/
    ...
    impl alloy_sol_types::SolInterface for ISignatureSchemeAddressProviderCalls {
        const NAME: &'static str = "ISignatureSchemeAddressProviderCalls";
...
See the [module-level documentation](self) for all the available methods.*/
    ...
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for ISignatureSchemeAddressProviderInstance<P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ISignatureSchemeAddressProviderInstance")
                .field(&self.address)
                .finish()
        }
    }
